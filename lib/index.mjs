...
class Scp {
    ...
    send({ destination, source }) {
        return this.#proc(source, this.user !== undefined ? `${this.user}@${this.host}:${destination}` : `${this.destination}:${source}`);
    }
...
export function CreateScpConnection(options) { return new Scp(options) };
export default Scp;